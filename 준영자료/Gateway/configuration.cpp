...
void setLoRaReceiveWaitTime(loraConfiguration *configLoRaData, uint8_t mode)
{
 
  if(mode == 1)
                configLoRaData->loraTraffic.receiveWaitTime = 5000;
...
int getLoRaReceiveWaitTime(loraConfiguration *configLoRaData)
{
	return configLoRaData->loraTraffic.receiveWaitTime;
}
