...
if [ -e $file ]; then
if [ "$1" == "-clean" ]; then
echo "loraGateway.o -> purged"
rm ./loraGateway.o
else
echo "loraGateway already compiled"
fi
else if [ "$1" != "-clean" ]; then
echo "Compiling loraGateway... "
g++ -c loraGateway.cpp -o loraGateway.o -I  "$LIBRARY_DIR" -I "$ARDUPI_DIR" -I .
